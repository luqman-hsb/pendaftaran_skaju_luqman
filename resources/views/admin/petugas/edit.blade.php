...
@section('title', 'Edit Petugas - Sistem Akademik')
        ...
        <form action="{{ route('admin.petugas.update', $petugas) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap', $petugas->nama_lengkap) }}" 
                ...
                <div>
                    ...
                    <input type="text" id="jabatan" name="jabatan" value="{{ old('jabatan', $petugas->jabatan) }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
