...
@section('title', 'Edit IDUKA - Sistem Akademik')
...
<div class="p-6">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Edit Data IDUKA</h1>
    </div>

    <div class="bg-white rounded-xl shadow-md border border-gray-200 p-6 max-w-4xl">
        <form action="{{ route('admin.iduka.update', $iduka) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="nama_iduka" name="nama_iduka" value="{{ old('nama_iduka', $iduka->nama_iduka) }}" 
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="bidang_usaha" name="bidang_usaha" value="{{ old('bidang_usaha', $iduka->bidang_usaha) }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                ...
                <div>
                    ...
                    <input type="number" id="kuota" name="kuota" value="{{ old('kuota', $iduka->kuota) }}" min="0"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                           required>
                    @error('kuota')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input type="text" id="kontak_person" name="kontak_person" value="{{ old('kontak_person', $iduka->kontak_person) }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                ...
                <div>
                    ...
                    <input type="text" id="no_telp" name="no_telp" value="{{ old('no_telp', $iduka->no_telp) }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', $iduka->email) }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="alamat" name="alamat" rows="4"
                              ...
                              placeholder="Alamat lengkap IDUKA" required>{{ old('alamat', $iduka->alamat) }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
